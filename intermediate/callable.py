...
StringArgInput = Callable[[str], None]


def accept_single_string_input(func: StringArgInput) -> None:
    pass
...
# accept_single_string_input(int_value)  # error
# accept_single_string_input(new_name)  # error
